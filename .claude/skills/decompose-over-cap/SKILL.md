...
- **Pair every extracted conditional/derivation with a test in the same commit** if it wasn't
  already covered (see `filterVisibility.test.ts`, `conditionsFieldTree.test.ts`). Hard to
