    ...
    <section className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Individual podcasts, optionally grouped under a media property and synced from their RSS
          feed. Bookmarks link to a podcast here. Click one to view or edit it.
        </p>
      </div>
