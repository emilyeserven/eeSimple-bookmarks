    ...
    <section className="space-y-6">
      <div className="space-y-1">
        <div className="flex items-center gap-2">
          <h1 className="text-2xl font-bold">{t("Media Types")}</h1>
          {allMediaTypes
            ? (
        ...
        <p className="text-sm text-muted-foreground">
          {t("Browse the Media Types taxonomy. Built-in types ship with the app; add your own below. Click a type to view or edit it.")}
        </p>
      </div>
