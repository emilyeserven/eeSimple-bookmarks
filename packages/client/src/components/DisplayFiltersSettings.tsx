            ...
            {rows.map(row => (
              ...
              >
                ...
                >
                  ...
                  <ToggleGroupItem value="on-demand">On demand</ToggleGroupItem>
                </ToggleGroup>
              </div>
            ))}
          </div>
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Choose which filters show by default in the filter sidebar. Filters set to “On demand” are
          hidden until you add them from the “Add filter” control.
        </p>
      </div>
      ...
      <Card>
        <CardContent className="space-y-6 pt-6">
          <FilterRows
            ...
            description="Built-in facets such as tags, category, and media type."
            rows={FILTER_FACETS}
            onDemand={onDemand}
          ...
          <FilterRows
            ...
            description="Each enabled custom property can be shown by default or added on demand."
            rows={propertyRows}
            onDemand={onDemand}
            onSetMode={setFilterMode}
          />
