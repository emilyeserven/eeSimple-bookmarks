...
test("defaultBodyZone routes description, romanizedTitle, and header fields to card-single-top", () => {
  assert.equal(defaultBodyZone("description"), "card-single-top");
  assert.equal(defaultBodyZone("romanizedTitle"), "card-single-top");
