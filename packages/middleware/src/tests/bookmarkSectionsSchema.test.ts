...
test("sectionsValues round-trips `completed`, `excludeFromProgress`, `isFavorite`, `url`, and `tagIds` on entries and children (not stripped by removeAdditional)", async () => {
